...
class sspmod_authgoogle_Auth_Source_GoogleOIDC extends SimpleSAML_Auth_Source {
	...
	public function authenticate(&$state) {
		...
		SimpleSAML_Logger::debug('Google authentication :  state ID = ' . $this->getStateID());
	...
	public function finalStep(&$state) {
		...
		*/
		...
		if ($response['expires_in']< time()) {$url = ('https://www.googleapis.com/plus/v1/people/me/openIdConnect?access_token='.$accesstoken);}
